package bpsolver.pattern.tests;

import Datastructures.Vector2d;
import FargGeneral.network.Node;
import bpsolver.nodes.FeatureNode;
import bpsolver.nodes.NumeriosityNode;
import bpsolver.pattern.Grouping;
import bpsolver.pattern.MatchingUpdateImplementationForObjectCenters;
import bpsolver.pattern.Pattern;
