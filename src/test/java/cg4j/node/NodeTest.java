...
import static org.junit.Assert.assertTrue;
 ...
 class NodeTest {
    ...
    void shapeEndCompatible1() {
        ...
        assertTrue(TensorNode.ShapeEndCompatible(shape1, 0, shape2, 0));
    }
    ...
    void shapeEndCompatible2() {
        ...
        assertTrue(TensorNode.ShapeEndCompatible(shape1, 0, shape2, 1));
    }
    ...
    void shapeEndCompatible4() {
        ...
        assertTrue(TensorNode.ShapeEndCompatible(shape1, 1, shape2, 0));
    }
    ...
    void shapeEndCompatible5() {
        ...
        assertFalse(TensorNode.ShapeEndCompatible(shape1, 0, shape2, 0));
    }
    ...
    void shapeEndCompatible6() {
        ...
        assertFalse(TensorNode.ShapeEndCompatible(shape1, 0, shape2, 1));
    }
    ...
    void shapeEndCompatible8() {
        ...
        int[] shape1 = {3, 4, 1, 4, 3};
        assertFalse(TensorNode.ShapeEndCompatible(shape1, 1, shape2, 0));
    }
